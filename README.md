...
```shell
gem build cybrid_api_organization.gemspec
```

Then either install the gem locally:

```shell
gem install ./cybrid_api_organization-0.0.29.gem
```

(for development, run `gem install --dev ./cybrid_api_organization-0.0.29.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'cybrid_api_organization', '~> 0.0.29'

### Install from Git

If the Ruby gem is hosted at a git repository: https://github.com/GIT_USER_ID/GIT_REPO_ID, then add the following in the Gemfile:

    gem 'cybrid_api_organization', :git => 'https://github.com/GIT_USER_ID/GIT_REPO_ID.git'
