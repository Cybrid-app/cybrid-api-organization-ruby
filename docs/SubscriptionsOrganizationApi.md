...
post_subscription_organization_model = CybridApiOrganization::PostSubscriptionOrganizationModel.new({environment: 'sandbox', type: 'webhook', name: 'name_example'}) # PostSubscriptionOrganizationModel | 
