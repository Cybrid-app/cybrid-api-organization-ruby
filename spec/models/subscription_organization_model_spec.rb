...
# Unit tests for CybridApiOrganization::SubscriptionOrganizationModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiOrganization::SubscriptionOrganizationModel do
  let(:instance) { CybridApiOrganization::SubscriptionOrganizationModel.new }

  describe 'test an instance of SubscriptionOrganizationModel' do
    it 'should create an instance of SubscriptionOrganizationModel' do
      expect(instance).to be_instance_of(CybridApiOrganization::SubscriptionOrganizationModel)
    end
  end
  ...
  describe 'test attribute "deliveries_failing_since"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
