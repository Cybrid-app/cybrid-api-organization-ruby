...
module CybridApiOrganization
  class SubscriptionOrganizationModel
    ...
    attr_accessor :deliveries_failing_since
    ...
    def self.attribute_map
      {
        ...
        :'recipient' => :'recipient',
        :'deliveries_failing_since' => :'deliveries_failing_since',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'deliveries_failing_since')
        self.deliveries_failing_since = attributes[:'deliveries_failing_since']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deliveries_failing_since == o.deliveries_failing_since &&
    ...
    def hash
      [guid, organization_guid, name, type, url, signing_key, recipient, deliveries_failing_since, environment, state, failure_code, created_at, updated_at].hash
    end
