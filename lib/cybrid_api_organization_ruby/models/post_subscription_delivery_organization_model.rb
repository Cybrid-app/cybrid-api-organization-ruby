...
module CybridApiOrganization
  ...
  class PostSubscriptionDeliveryOrganizationModel
    # The event guid .
    attr_accessor :subscription_event_guid
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiOrganization::PostSubscriptionDeliveryOrganizationModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiOrganization::PostSubscriptionDeliveryOrganizationModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @subscription_event_guid.to_s.length > 32
        invalid_properties.push('invalid value for "subscription_event_guid", the character length must be smaller than or equal to 32.')
      end

      if @subscription_event_guid.to_s.length < 32
        invalid_properties.push('invalid value for "subscription_event_guid", the character length must be great than or equal to 32.')
      end
      ...
      if @subscription_guid.to_s.length > 32
        invalid_properties.push('invalid value for "subscription_guid", the character length must be smaller than or equal to 32.')
      end

      if @subscription_guid.to_s.length < 32
        invalid_properties.push('invalid value for "subscription_guid", the character length must be great than or equal to 32.')
      end
    ...
    def valid?
      ...
      return false if @subscription_event_guid.to_s.length > 32
      return false if @subscription_event_guid.to_s.length < 32
      return false if @subscription_guid.nil?
      return false if @subscription_guid.to_s.length > 32
      return false if @subscription_guid.to_s.length < 32
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] subscription_event_guid Value to be assigned
    def subscription_event_guid=(subscription_event_guid)
      if subscription_event_guid.nil?
        fail ArgumentError, 'subscription_event_guid cannot be nil'
      end

      if subscription_event_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "subscription_event_guid", the character length must be smaller than or equal to 32.'
      end

      if subscription_event_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "subscription_event_guid", the character length must be great than or equal to 32.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] subscription_guid Value to be assigned
    def subscription_guid=(subscription_guid)
      if subscription_guid.nil?
        fail ArgumentError, 'subscription_guid cannot be nil'
      end

      if subscription_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "subscription_guid", the character length must be smaller than or equal to 32.'
      end

      if subscription_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "subscription_guid", the character length must be great than or equal to 32.'
      end
    ...
    def hash
      [subscription_event_guid, subscription_guid].hash
    end
