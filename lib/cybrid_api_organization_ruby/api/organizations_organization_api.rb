...
module CybridApiOrganization
  class OrganizationsOrganizationApi
    ...
    # @param organization_guid [String] Identifier for the organization.
    ...
    # @param organization_guid [String] Identifier for the organization.
    # @param [Hash] opts the optional parameters
    # @return [Array<(OrganizationOrganizationModel, Integer, Hash)>] OrganizationOrganizationModel data, response status code and response headers
    ...
    # @param organization_guid [String] Identifier for the organization.
    # @param patch_organization_organization_model [PatchOrganizationOrganizationModel] 
    # @param [Hash] opts the optional parameters
    # @return [OrganizationOrganizationModel]
