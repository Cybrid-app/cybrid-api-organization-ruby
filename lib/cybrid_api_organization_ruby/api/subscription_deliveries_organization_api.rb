...
module CybridApiOrganization
  class SubscriptionDeliveriesOrganizationApi
    ...
    # @option opts [String] :state Comma separated states to list subscription deliveries for.
    # @option opts [String] :event_type Comma separated event types to list subscription deliveries for.
    # @option opts [String] :completed_at_gte ISO8601 datetime; only deliveries completed at or after this time are returned.
    # @option opts [String] :completed_at_lt ISO8601 datetime; only deliveries completed before this time are returned.
    ...
    def list_subscription_deliveries_with_http_info(opts = {})
      ...
      query_params[:'completed_at_gte'] = opts[:'completed_at_gte'] if !opts[:'completed_at_gte'].nil?
      query_params[:'completed_at_lt'] = opts[:'completed_at_lt'] if !opts[:'completed_at_lt'].nil?
