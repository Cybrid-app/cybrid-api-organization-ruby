...
module CybridApiOrganization
  class SubscriptionEventsOrganizationApi
    ...
    # @param subscription_event_guid [String] Identifier for the Subscription Event.
    ...
    # @param subscription_event_guid [String] Identifier for the Subscription Event.
    # @param [Hash] opts the optional parameters
    # @return [Array<(SubscriptionEventOrganizationModel, Integer, Hash)>] SubscriptionEventOrganizationModel data, response status code and response headers
    ...
    # @option opts [String] :guid Comma separated subscription_event_guids to list subscription events for.
    ...
    # @option opts [Integer] :per_page The number of entities per page to return.
    # @option opts [String] :guid Comma separated subscription_event_guids to list subscription events for.
    # @return [Array<(SubscriptionEventListOrganizationModel, Integer, Hash)>] SubscriptionEventListOrganizationModel data, response status code and response headers
